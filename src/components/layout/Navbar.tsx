    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#F8F9FC]/80 backdrop-blur-md border-b border-black/[0.05]">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="#download" className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-[#00C853] hover:bg-[#00A846] text-white! text-xs font-bold transition-all shadow-sm">
